...
(function () {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelector(`#wpforms-${formId}-field_4`).value = userId; //  const vehicleTypes = document.querySelector('.casauto-preferences-wrapper pre').textContent;

    console.log(meanContact); // if(vehicleTypes){
